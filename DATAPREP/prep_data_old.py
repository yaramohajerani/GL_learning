...
nx_tile=512
ny_tile=512
dirx=False #Chopping from left to right when True, other way arounw when False
diry=False #Chopping from upper to bottom when True, other way arounw when False
