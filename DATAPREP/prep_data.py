...
class csk:
    #NOTE: The implementation below is just the copy of the class 'sentinel1' above.
    #      Use the following codes just only for the framework.
    #TODO: Modity the codes below to suit into CSK
